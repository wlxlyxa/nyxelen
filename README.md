...
前往 [Releases](https://github.com/wlxlyxa/nyxelen/releases) 或 [nyxelen.com](https://nyxelen.com) 下载 Windows 安装包（`Nyxelen_*_x64-setup.exe`）。

> 已安装旧版「望仔（WangZai）」的用户：直接安装 Nyxelen 即可。订阅、配置与激活状态随数据目录保留，无需重新配置。
