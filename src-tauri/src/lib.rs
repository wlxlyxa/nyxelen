...
mod app_init {
    ...
    pub fn generate_handlers() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
        tauri::generate_handler![
            ...
            cmd::download_subscription_text,
            cmd::open_system_restore,
            cmd::launch_rescue,
            cmd::enable_teredo_protection,
            cmd::disable_teredo_protection,
            cmd::check_teredo_protection_status,
            cmd::enable_broadcast_protection,
            cmd::disable_broadcast_protection,
            cmd::check_broadcast_protection_status,
            cmd::emergency_rescue,
            cmd::create_system_restore_point,
            cmd::check_privacy_suite_status,
            ...
            cmd::enable_quic_protection,
            cmd::disable_quic_protection,
            cmd::check_quic_protection_status,
            cmd::enable_wpad_protection,
            cmd::disable_wpad_protection,
            cmd::check_wpad_protection_status,
            cmd::enable_ocsp_protection,
            cmd::disable_ocsp_protection,
            cmd::check_ocsp_protection_status,
            cmd::enable_llmnr_protection,
            cmd::disable_llmnr_protection,
            cmd::check_llmnr_protection_status,
            cmd::enable_dns_cache_guard,
            cmd::disable_dns_cache_guard,
            cmd::check_dns_cache_guard_status,
        ]
    }
}
    ...
    mod event_handlers {
        ...
        pub fn handle_ready_resumed(_app_handle: &AppHandle) {
            ...
            if let Some(window) = _app_handle.get_webview_window("main") {
                let _ = window.set_title("Nyxelen");
            }
        }
